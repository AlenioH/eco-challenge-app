exports.up = async (sql) => {
  ...
  ('Car-free day', '/oeffis.jpg', 'transportation', 'On a day when you would normally use a car, try taking public transportation instead!'),
	('Clean-plate day', '/clean-plate.jpg', 'food', 'For one day think carefully of the amount of food you are preparing in order to avoid wasting food. In case you have leftovers, keep them and use them as a base for new creative recipies the next day!'),
